...
class Ui_EventView(object):
    ...
    def retranslateUi(self, EventView):
        EventView.setWindowTitle(QCoreApplication.translate("EventView", u"Events", None))
        self.addButton.setText(QCoreApplication.translate("EventView", u"Add", None))
        self.deleteButton.setText(QCoreApplication.translate("EventView", u"Delete", None))
